...
export default function Navbar({
  ...
  return (
    <header className="border-b border-theme-accent bg-[#080c16]/95 backdrop-blur sticky top-0 z-50 px-4 py-2 w-full min-h-[56px] flex items-center justify-between shadow-lg">
      {/* Brand & Security Clearance (Left Side) */}
