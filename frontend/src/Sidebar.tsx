...
const INVESTIGATION: NavItem[] = [
  ...
  { key: "graph", label: "Investigation Graph", icon: <NetworkIcon width={17} height={17} />, available: true },
  { key: "search", label: "Threat Actors", icon: <UserIcon width={17} height={17} />, available: true },
  { key: "infrastructure", label: "Infrastructure (P1)", icon: <ServerIcon width={17} height={17} />, available: true },
  { key: "attribution", label: "DACS Attribution", icon: <LinkIcon width={17} height={17} />, available: true },
